...
*}
<link href="{$css_dir|escape:''}modules/dinterval/css/counter.css" rel="stylesheet">
...
<script>
    ...
    var countEnd = '{if $date_end|date_format:"%m" == "01"}{l s="Jan" mod="dinterval"}{elseif $date_end|date_format:"%m" == "02"}{l s="Feb" mod="dinterval"}{elseif $date_end|date_format:"%m" == "03"}Mar{elseif $date_end|date_format:"%m" == "04"}Apr{elseif $date_end|date_format:"%m" == "05"}May{elseif $date_end|date_format:"%m" == "06"}Jun{elseif $date_end|date_format:"%m" == "07"}Jul{elseif $date_end|date_format:"%m" == "08"}Aug{elseif $date_end|date_format:"%m" == "09"}Sep{elseif $date_end|date_format:"%m" == "10"}Oct{elseif $date_end|date_format:"%m" == "11"}Nov{elseif $date_end|date_format:"%m" == "12"}Dec{/if}';
